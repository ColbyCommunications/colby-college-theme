module.exports = {
    ...
    context: {
        ...
        heading:
            "We are taking an integrated, values-led approach to this campaign to reflect the realities of the world we're trying to better. Supporting any one of them will benefit all.",
