            ...
            <div class="section-nav__inner flex px-5 space-x-10 lg:justify-center">
                ...
                <ul class="flex items-center space-x-7 pr-9 md:pr-0">
                    <li
                        ...
                        class="font-body font-medium text-14 md:text-10 text-indigo-800 leading-130 whitespace-nowrap"
                    >
                        <button
                    ...
                    <div class="context w-full space-y-5">
                        <div class="text-group--animated text-group text-group--animated">
                            ...
                            <p
                                ...
                                v-text="stripHTML(item.time)"
                            />
                        </div>
                        <div
                            class="button-group--animated button-group flex flex-wrap gap-4 shrink-0"
                        >
                            <a
                                v-if="type == 'light'"
                                class="btn group inline-flex flex-row items-center space-x-1.5 rounded border border-solid border-indigo-300 hover:border-indigo-500 font-body font-normal text-10 leading-130 !no-underline text-indigo bg-indigo-100 hover:bg-indigo-200 focus:bg-indigo-200 focus:outline focus:outline-2 focus:outline-canary outline-offset-[-1px] py-1 px-3 transition-all duration-200 ease-in-out !opacity-100 !translate-x-0"
                                :href="item.url"
                                target="_blank"
                            >
                            ...
                            <a
                                v-if="type == 'dark'"
                                class="btn group inline-flex flex-row items-center space-x-1.5 rounded border border-solid border-indigo-800 hover:border-indigo-800 font-body font-normal text-10 leading-130 !no-underline text-white bg-indigo/20 focus:outline focus:outline-2 focus:outline-canary outline-offset-[-1px] py-1 px-3 transition-all duration-200 ease-in-out !opacity-100 !translate-x-0"
                                :href="item.url"
                                target="_blank"
                            >
                                <span class="btn__text">
                                    Learn More
                                    <div
                                        class="btn__border block bg-white h-px w-0 group-hover:w-full transition-all duration-200 ease-in-out"
                                    ></div
                                ></span>
                            </a>
                        </div>
    ...
    export default {
        ...
        props: {
            ...
            initialEndpoint: {
                ...
                required: false,
                default:
                    'https://events.colby.edu/live/json/events/group/Colby%20Arts%20EMS/group/Museum%20of%20Art/group/Art/group/Center%20for%20Arts%20and%20Humanities/group/Creative%20Writing/group/Music/group/Cinema%20Studies/group/Performance%2C%20Theater%2C%20%26%20Dance',
            },
            limit: {
                type: Number,
                required: false,
