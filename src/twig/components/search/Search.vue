    ...
    <div class="search" v-if="modalOpen">
        ...
        >
            ...
            <div class="qs mb-12" role="region" aria-label="Query Suggestions`">
                <ais-index :index-name="qs" index-id="colby-qs">
            ...
            />
            <div v-if="query">
                <ais-index :index-name="index" index-id="results">
                                        ...
                                        <article class="article space-y-4">
                                            <div class="context w-full space-y-5">
                                                <div class="text-group">
                                                    ...
                                                    <p
                                                        class="text-group__p font-body font-normal text-12 md:text-12 leading-130 text-left text-indigo-800 mt-2 break-words"
                                                    >
                                                        <ais-snippet
                                                            attribute="content"
                                                            :hit="item"
