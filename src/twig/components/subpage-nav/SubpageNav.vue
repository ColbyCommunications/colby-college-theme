<template>
    ...
    >
        <div class="subpage-nav--animated" ref="container">
            ...
            <ul
                class="subpage-nav__items md:block py-4 md:py-0 border-t md:border-t-0 border-solid border-indigo-200 mt-0"
                :class="{ hidden: !menuOpen }"
            >
                <li
                    v-if="parentpageheading"
