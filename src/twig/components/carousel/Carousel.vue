        ...
        <div class="context space-y-5">
          ...
          <div class="button-group flex flex-wrap gap-4">
            ...
            >
              ...
              <svg class="btn__arrow w-2 h-2 fill-azure" viewBox="0 0 12 12" xml:space="preserve">
                <path d="M10 1H.7V0H12v11.7h-1V1.4L.7 12l-.7-.7L10 1z" style="fill-rule: evenodd; clip-rule: evenodd;"></path>
              </svg>
            </a>
          </div>
        </div>
      ...
      >
        ...
        <div class="carousel__slides-context relative mt-6 h-40">
          <div
            ...
            :class="{ '!visible opacity-100 !translate-y-0': activeSlide == index }"
          >
            <div class="context space-y-5">
              <div class="text-group">
                <div
        ...
        <div class="context w-full space-y-5">
          ...
          <div class="button-group flex flex-wrap gap-4">
            <a
              ...
              :href="button.url"
            >
              <span class="btn__text">{{ button.title }}<div class="btn__border block bg-indigo h-px w-0 group-hover:w-full transition-all duration-200 ease-in-out"></div></span>
            </a>
          </div>
        </div>
        <div class="arrow-controls space-x-4">
...
export default {
  ...
  async mounted() {
    if (this.renderApi) {
      ...
      switch(this.api) {
        case 'Latest News':
          this.endpoint = 'https://news.colby.edu/wp-json/wp/v2/posts?per_page=5&tags=561&_embed=1';
          break;
        case 'Academic News':
