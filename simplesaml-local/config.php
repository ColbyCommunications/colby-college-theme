...
$config = array(
	...
	'certdir'                       => __DIR__ . '/simplesaml/cert/',
	'loggingdir'                    => __DIR__ . '/simplesaml/log/',
	'datadir'                       => __DIR__ . '/simplesaml/data/',
	'tempdir'                       => __DIR__ . '/simplesaml/tmp/simplesaml',
	 ...
	 */
	'session.duration'              => 4 * ( 60 * 60 ), // 4 hours.
	 ...
	 */
	'session.cookie.name'           => 'ColbyDirectorySAMLSessionID',
	 ...
	 */
	'session.phpsession.cookiename' => 'ColbyDirectorySAMLSession',
	 ...
	 */
	'session.authtoken.cookiename'  => 'ColbyDirectorySAMLAuthToken',
	...
	'metadatadir'                   => __DIR__ . '/simplesaml/metadata',

	'metadata.sources'              => array(
		array(
			'type' => 'xml',
			'url'  => 'https://okta.colby.edu/app/exkqw4m28ezS0DYyx357/sso/saml/metadata',
		),
	),
